...
public class BodyBuilders {
    ...
    public static DslPart catalogResources() {
        return header("common", "A catalog of common data", "common", "Common data catalog")
                .minArrayLike("resources", 1)
                    ...
                    .stringType("description", "A list of available datasets (for access or download in one or more formats)")
    ...
    public static DslPart datasetMembers() {
        ...
        return header("datasetseries/", "A list of available datasetseries of a dataset", "datasetseries", "DatasetSeries")
                .minArrayLike("resources", 1)
