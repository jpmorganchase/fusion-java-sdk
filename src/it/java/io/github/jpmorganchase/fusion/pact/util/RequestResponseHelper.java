...
public class RequestResponseHelper {
    ...
    public static RequestResponsePact getExpectation(PactDslWithProvider builder, String given, String upon, String path, DslPart body) {
        return builder
                .given(given)
                .uponReceiving(upon)
                    .path(path)
    ...
    public static RequestResponsePact downloadExpectation(PactDslWithProvider builder, String given, String upon, String path, String body){
        return builder
                .given(given)
                .uponReceiving(upon)
                    .path(path)
    ...
    public static RequestResponsePact uploadExpectation(PactDslWithProvider builder, String given, String upon, String authPath, String path, Map<String, String> headers, String body){
