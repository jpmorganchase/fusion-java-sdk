...
//                        "%1scatalogs/%2s/datasets/%3s/datasetseries", config.getRootURL(), "common",
// "sample_dataset")))
//                .thenReturn("{\"key\":value}");
...
//                        String.format("%1s/api/corelineage-service/v1/reports/%2s/reportElements", rootUrl,
// reportId)))
//                .thenReturn("{\"key\":value}");
...
//
//        when(apiManager.callAPI(
//                        String.format("%1scatalogs/%2s/datasets/%3s", config.getRootURL(), "common",
// "sample_dataset")))
//                .thenReturn("{\"key\":value}");
//        when(responseParser.parseResourcesUntyped("{\"key\":value}")).thenReturn(stubResponse);
//
