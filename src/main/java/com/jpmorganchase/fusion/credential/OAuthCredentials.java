...
public class OAuthCredentials implements IFusionCredentials{
    ...
    public OAuthCredentials(String clientId, String clientSecret, String resource, String authServerUrl) throws MalformedURLException {
